...
$.widget( "mobile.slider", $.extend( {
	...
	custom_label: false,
	label_callback: function() {return ''},
	...
	refresh: function( val, isfromControl, preventInputUpdate ) {
		...
		{
		   this.custom_label.html(this.label_callback(newval));
		}
	...
	setLabel: function(callback)
	{
	   this.label_callback = callback;
	   
	   this.custom_label = $('<div class="slider-label" style="width:100%;text-align:center;margin-top:10px">Coucou</div>'); 
	   this.slider.after(this.custom_label);
